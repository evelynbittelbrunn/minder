...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Set-2021 às 03:03
...
--
ALTER TABLE `tb_questao`
  MODIFY `idQuestao` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - Código identificador da questão';
...
--
ALTER TABLE `tb_tipoassunto`
  MODIFY `idTipoAssunto` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - Código identificador do tipo de assunto da questão';
