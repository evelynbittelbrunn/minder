...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28-Set-2021 às 04:26
...
(3, 1, 1, 1, 1, '(ENEM 2020) A caixa-d’água de um edifício terá a forma de um paralelepípedo retângulo reto com volume igual a 28 080 litros. Em uma maquete que representa o edifício, a caixa-d’água tem dimensões 2 cm × 3,51 cm × 4 cm.\r\n\r\nDado: 1 dm³ = 1 L.\r\n\r\nA escala usada pelo arquiteto foi', '', '2020', '1 : 10', '1 : 100', '1 : 1000', '1 : 10000', '1 : 100000', 'A'),
...
(1, 1, NULL, 'Evelyn ADM', 'eve@gmail.com', '202cb962ac59075b964b07152d234b70', 'S');
...
--
ALTER TABLE `tb_notificacao`
  MODIFY `idNotificacao` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - Código identificador da notificação', AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `tb_questao`
--
ALTER TABLE `tb_questao`
  MODIFY `idQuestao` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - Código identificador da questão', AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_usuario`
  MODIFY `idUsuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK - Código identificador do usuário', AUTO_INCREMENT=2;
